...
IF NOT EXIST package-lock.json CALL npm install && CALL npm ci && COPY /Y package-lock.json ..\package-lock.json
...
node awclogincheck.js --url=%1 --username=%2 --password=%3