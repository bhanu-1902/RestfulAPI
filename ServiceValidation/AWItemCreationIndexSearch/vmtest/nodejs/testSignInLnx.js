...
//		logger.info('JSessionID Before CreateDataSet: '+process.env.JSessionID);
		return testHelper.createDataset( itemRevision, "test.jpg", "/home2/yytcadm/Desktop/ServiceValidation/AWItemCreationIndexSearch/vmtest/test.jpg", "JPEG", "JPEG_Reference", false, "TC_Attaches" );
